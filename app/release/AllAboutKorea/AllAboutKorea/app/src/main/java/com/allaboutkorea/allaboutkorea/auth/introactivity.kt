...
import com.allaboutkorea.allaboutkorea.databinding.ActivityIntroactivityBinding
...
class introactivity : AppCompatActivity(),View.OnClickListener {
    ...
    private lateinit var binding : ActivityIntroactivityBinding
    //firebase Auth
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = DataBindingUtil.setContentView(this,R.layout.activity_introactivity)
        ...
        firebaseAuth.signInWithCredential(credential)
            .addOnCompleteListener(this) { task ->
                if (task.isSuccessful) {
                    Log.w("LoginActivity", "firebaseAuthWithGoogle Successful.", task.exception)
